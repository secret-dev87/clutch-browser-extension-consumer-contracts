...
contract Simple2FATest is Test {
    ...
    function setUp() public {
        ...
        (simple2FASignAddr, simple2FASignKey) = makeAddrAndKey(
            "simple2FASignKey"
        );
    }
    ...
    function setUpPlugin() private {
        ...
        securityControlModule.execute(
            ...
            abi.encodeWithSelector(
                ...
                abi.encodePacked(address(simple2FAPlugin), initData)
            )
        );
        ...
        assertEq(
            simple2FAPlugin.signerAddress(address(clutchWallet)),
            simple2FASignAddr
        );
    }

    function getSignerAddress() private view returns (address _signAddress) {
        return simple2FAPlugin.signerAddress(address(clutchWallet));
    }
    ...
    function test_2FA() public {
        ...
        bytes memory guardSig;
        {
            ...
            guardSig = abi.encodePacked(
                address(simple2FAPlugin),
                _sigLen,
                _sig
            );
        }
