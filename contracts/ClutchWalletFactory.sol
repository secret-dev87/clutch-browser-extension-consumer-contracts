...
contract ClutchWalletFactory is Ownable {
    ...
    /**
     * @notice  deploy the clutch wallet contract using proxy and returns the address of the proxy. should be called by entrypoint with useropeartoin.initcode > 0
     */
     ...
     * @dev     used by clutchwalletlib to calcudate the clutch wallet address.
     * @return  bytes  .
     */
