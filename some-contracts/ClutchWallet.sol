 ...
 * @dev     this is the implementation contract of the Clutch wallet. The contract support ERC4337 which can be called by the entrypoint contract with UserOperation.
 * @notice  .
 */
    ...
    DefaultCallbackHandler
{
    ...
    /**
     * @notice  initialized function to setup the clutch wallet contract.
     * @dev     .
    ...
    /**
     * @notice  change the clutch eoa address (signing key).
