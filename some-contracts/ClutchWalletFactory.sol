...
contract ClutchWalletFactory {
    ...
    /**
     * @notice  deploy the Clutch wallet contract using proxy and returns the address of the proxy.
    ...
    function createWallet(
        ...
        emit ClutchWalletCreated(proxy, _owner, walletImpl, VERSION);
     ...
     * @dev     used to calculate the Clutch wallet address.
     * @return  bytes  .
     */
    ...
    /**
     * @notice  return the counterfactual address of Clutch wallet as it would be return by createWallet()
     * @dev     .
     ...
     * @return  address  return computed Clutch wallet address.
     */
